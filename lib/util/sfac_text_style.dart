...
class SFTextStyle {
  ...
  //본문 미디엄폰트 20사이즈
  static TextStyle b1M20({Color color = Colors.black}) =>
      TextStyle(fontFamily: 'PretendardMedium', fontSize: 20, color: color);

  //본문 레귤러폰트 20사이즈
  static TextStyle b1R20({Color color = Colors.black}) =>
  ...
  //본문 레귤러폰트 18사이즈
  static TextStyle b2R18({Color color = Colors.black}) =>
      TextStyle(fontFamily: 'PretendardRegular', fontSize: 18, color: color);
